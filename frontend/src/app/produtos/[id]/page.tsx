...
import type { Categoria, Produto, UnidadeAlternativa, Unidade } from "@/modules/produtos/types";
        ...
        <section className="mt-12 border-t border-[#dbe1e4] pt-8">
          ...
          {alternativas.length > 0 ? (
            ...
            <p className="mt-6 text-sm text-[#5b6b75]">
              Nenhuma ainda. Um bolo vendido em fatias, por exemplo, tem uma unidade &quot;Fatia&quot;
              valendo 0,125.
            </p>
          )}
